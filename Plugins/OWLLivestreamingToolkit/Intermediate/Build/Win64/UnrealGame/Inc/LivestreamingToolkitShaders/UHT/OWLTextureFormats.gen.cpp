...
template<> LIVESTREAMINGTOOLKITSHADERS_API UEnum* StaticEnum<EOWLTexturePixelFormat>()
{
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkitShaders_Public_OWLTextureFormats_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EOWLTexturePixelFormat_StaticEnum, TEXT("EOWLTexturePixelFormat"), &Z_Registration_Info_UEnum_EOWLTexturePixelFormat, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 81023615U) },
		{ EOWLPixelLayoutFormat_StaticEnum, TEXT("EOWLPixelLayoutFormat"), &Z_Registration_Info_UEnum_EOWLPixelLayoutFormat, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2409684570U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkitShaders_Public_OWLTextureFormats_h_3888518244(TEXT("/Script/LivestreamingToolkitShaders"),
	nullptr, 0,
	nullptr, 0,
	Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkitShaders_Public_OWLTextureFormats_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkitShaders_Public_OWLTextureFormats_h_Statics::EnumInfo));
// End Registration
