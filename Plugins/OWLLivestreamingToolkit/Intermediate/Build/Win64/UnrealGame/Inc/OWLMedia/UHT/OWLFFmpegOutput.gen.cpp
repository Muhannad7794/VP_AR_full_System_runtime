...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OWLMedia_EOWLMediaOutputType_Statics::EnumParams = {
	...
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_OWLMedia_EOWLMediaOutputType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_OWLMedia_EOWLMediaOutputType_Statics::Enum_MetaDataParams)
};
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OWLMedia_EOWLDestinationFormat_Statics::EnumParams = {
	...
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_OWLMedia_EOWLDestinationFormat_Statics::Enum_MetaDataParams), Z_Construct_UEnum_OWLMedia_EOWLDestinationFormat_Statics::Enum_MetaDataParams)
};
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OWLMedia_EOWLHttpFormat_Statics::EnumParams = {
	...
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_OWLMedia_EOWLHttpFormat_Statics::Enum_MetaDataParams), Z_Construct_UEnum_OWLMedia_EOWLHttpFormat_Statics::Enum_MetaDataParams)
};
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OWLMedia_EOWLSRTPubKeyLen_Statics::EnumParams = {
	...
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_OWLMedia_EOWLSRTPubKeyLen_Statics::Enum_MetaDataParams), Z_Construct_UEnum_OWLMedia_EOWLSRTPubKeyLen_Statics::Enum_MetaDataParams)
};
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OWLMedia_EOWLAudioChannelLayout_Statics::EnumParams = {
	...
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_OWLMedia_EOWLAudioChannelLayout_Statics::Enum_MetaDataParams), Z_Construct_UEnum_OWLMedia_EOWLAudioChannelLayout_Statics::Enum_MetaDataParams)
};
...
struct Z_Construct_UScriptStruct_FOWLSRTOptions_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_PubKeyLen_MetaData[] = {
		{ "Category", "Output Settings" },
		{ "Comment", "/* Crypto key length */" },
		{ "ModuleRelativePath", "Public/OWLFFmpegOutput.h" },
		{ "ToolTip", "Crypto key length" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_Passphrase_MetaData[] = {
		{ "Category", "Output Settings" },
...
const UECodeGen_Private::FInt64PropertyParams Z_Construct_UScriptStruct_FOWLSRTOptions_Statics::NewProp_Timeout = { "Timeout", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int64, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOWLSRTOptions, Timeout), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Timeout_MetaData), NewProp_Timeout_MetaData) };
const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FOWLSRTOptions_Statics::NewProp_PubKeyLen_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FOWLSRTOptions_Statics::NewProp_PubKeyLen = { "PubKeyLen", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOWLSRTOptions, PubKeyLen), Z_Construct_UEnum_OWLMedia_EOWLSRTPubKeyLen, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PubKeyLen_MetaData), NewProp_PubKeyLen_MetaData) }; // 1679949795
const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FOWLSRTOptions_Statics::NewProp_Passphrase = { "Passphrase", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOWLSRTOptions, Passphrase), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Passphrase_MetaData), NewProp_Passphrase_MetaData) };
const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FOWLSRTOptions_Statics::NewProp_StreamID = { "StreamID", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOWLSRTOptions, StreamID), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_StreamID_MetaData), NewProp_StreamID_MetaData) };
const UECodeGen_Private::FInt64PropertyParams Z_Construct_UScriptStruct_FOWLSRTOptions_Statics::NewProp_Latency = { "Latency", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int64, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOWLSRTOptions, Latency), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Latency_MetaData), NewProp_Latency_MetaData) };
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOWLSRTOptions_Statics::PropPointers) < 2048);
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FOWLSRTOptions_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_OWLMedia,
	nullptr,
	&NewStructOps,
	"OWLSRTOptions",
	...
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOWLSRTOptions_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FOWLSRTOptions_Statics::Struct_MetaDataParams)
};
UScriptStruct* Z_Construct_UScriptStruct_FOWLSRTOptions()
{
	if (!Z_Registration_Info_UScriptStruct_OWLSRTOptions.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_OWLSRTOptions.InnerSingleton, Z_Construct_UScriptStruct_FOWLSRTOptions_Statics::StructParams);
	}
...
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FOWLAudioSampleBlock_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_OWLMedia,
	nullptr,
	&NewStructOps,
	"OWLAudioSampleBlock",
	...
	RF_Public|RF_Transient|RF_MarkAsNative,
	EStructFlags(0x00000201),
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOWLAudioSampleBlock_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FOWLAudioSampleBlock_Statics::Struct_MetaDataParams)
};
UScriptStruct* Z_Construct_UScriptStruct_FOWLAudioSampleBlock()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_OWLAudioSampleBlock.InnerSingleton, Z_Construct_UScriptStruct_FOWLAudioSampleBlock_Statics::StructParams);
	}
...
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FOWLEncodedPacket_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_OWLMedia,
	nullptr,
	&NewStructOps,
	"OWLEncodedPacket",
	...
	RF_Public|RF_Transient|RF_MarkAsNative,
	EStructFlags(0x00000201),
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOWLEncodedPacket_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FOWLEncodedPacket_Statics::Struct_MetaDataParams)
};
UScriptStruct* Z_Construct_UScriptStruct_FOWLEncodedPacket()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_OWLEncodedPacket.InnerSingleton, Z_Construct_UScriptStruct_FOWLEncodedPacket_Statics::StructParams);
	}
...
struct Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_EncodeAudio_MetaData[] = {
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_UseUEHardwareEncoder_MetaData[] = {
		{ "Category", "Encoder Settings" },
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_AudioBitrate_MetaData[] = {
		{ "Category", "Encoder Settings" },
		{ "ClampMax", "320" },
		{ "ClampMin", "80" },
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_AudioChannelLayout_MetaData[] = {
		{ "Category", "Encoder Settings" },
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_QMax_MetaData[] = {
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_QMin_MetaData[] = {
		{ "Category", "Advanced Encoder Settings" },
		{ "ClampMax", "50" },
		{ "ClampMin", "15" },
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_GOPSize_MetaData[] = {
		{ "Category", "Advanced Encoder Settings" },
		{ "ClampMax", "30" },
		{ "ClampMin", "10" },
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_FramesPerIframe_MetaData[] = {
		{ "Category", "Advanced Encoder Settings" },
		{ "ClampMax", "240" },
		{ "ClampMin", "5" },
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bOutputCustomResolution_MetaData[] = {
		{ "Category", "Advanced Encoder Settings" },
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_AudioOffsetMs_MetaData[] = {
		{ "Category", "Advanced Encoder Settings" },
		{ "ClampMax", "1500" },
		{ "ClampMin", "-1500" },
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bFragmentFile_MetaData[] = {
	...
	static const UECodeGen_Private::FIntPropertyParams NewProp_AudioBitrate;
	...
	static const UECodeGen_Private::FIntPropertyParams NewProp_Profile_Underlying;
	...
	static const UECodeGen_Private::FIntPropertyParams NewProp_FramesPerIframe;
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewProp_EncodeAudio = { "EncodeAudio", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FOWLFFmpegSettings), &Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewProp_EncodeAudio_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_EncodeAudio_MetaData), NewProp_EncodeAudio_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewProp_UseUEHardwareEncoder = { "UseUEHardwareEncoder", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FOWLFFmpegSettings), &Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewProp_UseUEHardwareEncoder_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_UseUEHardwareEncoder_MetaData), NewProp_UseUEHardwareEncoder_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewProp_VideoBitrate = { "VideoBitrate", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOWLFFmpegSettings, VideoBitrate), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_VideoBitrate_MetaData), NewProp_VideoBitrate_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewProp_AudioBitrate = { "AudioBitrate", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOWLFFmpegSettings, AudioBitrate), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AudioBitrate_MetaData), NewProp_AudioBitrate_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewProp_Submix = { "Submix", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOWLFFmpegSettings, Submix), Z_Construct_UClass_USoundSubmix_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Submix_MetaData), NewProp_Submix_MetaData) };
const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewProp_AudioChannelLayout_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewProp_AudioChannelLayout = { "AudioChannelLayout", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOWLFFmpegSettings, AudioChannelLayout), Z_Construct_UEnum_OWLMedia_EOWLAudioChannelLayout, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AudioChannelLayout_MetaData), NewProp_AudioChannelLayout_MetaData) }; // 1671667704
const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewProp_QMax = { "QMax", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOWLFFmpegSettings, QMax), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_QMax_MetaData), NewProp_QMax_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewProp_QMin = { "QMin", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOWLFFmpegSettings, QMin), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_QMin_MetaData), NewProp_QMin_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewProp_Profile_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewProp_Profile = { "Profile", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOWLFFmpegSettings, Profile), Z_Construct_UEnum_OWLMedia_EOWLEncoderProfile, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Profile_MetaData), NewProp_Profile_MetaData) }; // 1983132077
const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewProp_GOPSize = { "GOPSize", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOWLFFmpegSettings, GOPSize), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_GOPSize_MetaData), NewProp_GOPSize_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewProp_FramesPerIframe = { "FramesPerIframe", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOWLFFmpegSettings, FramesPerIframe), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_FramesPerIframe_MetaData), NewProp_FramesPerIframe_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewProp_bOutputCustomResolution = { "bOutputCustomResolution", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FOWLFFmpegSettings), &Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewProp_bOutputCustomResolution_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bOutputCustomResolution_MetaData), NewProp_bOutputCustomResolution_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewProp_CustomOutputResolution = { "CustomOutputResolution", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOWLFFmpegSettings, CustomOutputResolution), Z_Construct_UScriptStruct_FIntPoint, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CustomOutputResolution_MetaData), NewProp_CustomOutputResolution_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewProp_AudioOffsetMs = { "AudioOffsetMs", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOWLFFmpegSettings, AudioOffsetMs), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AudioOffsetMs_MetaData), NewProp_AudioOffsetMs_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewProp_bFragmentFile = { "bFragmentFile", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FOWLFFmpegSettings), &Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewProp_bFragmentFile_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bFragmentFile_MetaData), NewProp_bFragmentFile_MetaData) };
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::PropPointers) < 2048);
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_OWLMedia,
	nullptr,
	&NewStructOps,
	"OWLFFmpegSettings",
	...
	RF_Public|RF_Transient|RF_MarkAsNative,
	EStructFlags(0x00000201),
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::Struct_MetaDataParams)
};
UScriptStruct* Z_Construct_UScriptStruct_FOWLFFmpegSettings()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_OWLFFmpegSettings.InnerSingleton, Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::StructParams);
	}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLMedia_Public_OWLFFmpegOutput_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EOWLMediaOutputType_StaticEnum, TEXT("EOWLMediaOutputType"), &Z_Registration_Info_UEnum_EOWLMediaOutputType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2979194322U) },
		{ EOWLDestinationFormat_StaticEnum, TEXT("EOWLDestinationFormat"), &Z_Registration_Info_UEnum_EOWLDestinationFormat, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2375719469U) },
		{ EOWLHttpFormat_StaticEnum, TEXT("EOWLHttpFormat"), &Z_Registration_Info_UEnum_EOWLHttpFormat, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2195858000U) },
		{ EOWLSRTPubKeyLen_StaticEnum, TEXT("EOWLSRTPubKeyLen"), &Z_Registration_Info_UEnum_EOWLSRTPubKeyLen, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1679949795U) },
		{ EOWLAudioChannelLayout_StaticEnum, TEXT("EOWLAudioChannelLayout"), &Z_Registration_Info_UEnum_EOWLAudioChannelLayout, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1671667704U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FOWLSRTOptions::StaticStruct, Z_Construct_UScriptStruct_FOWLSRTOptions_Statics::NewStructOps, TEXT("OWLSRTOptions"), &Z_Registration_Info_UScriptStruct_OWLSRTOptions, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOWLSRTOptions), 1996186344U) },
		{ FOWLAudioSampleBlock::StaticStruct, Z_Construct_UScriptStruct_FOWLAudioSampleBlock_Statics::NewStructOps, TEXT("OWLAudioSampleBlock"), &Z_Registration_Info_UScriptStruct_OWLAudioSampleBlock, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOWLAudioSampleBlock), 2777705813U) },
		{ FOWLEncodedPacket::StaticStruct, Z_Construct_UScriptStruct_FOWLEncodedPacket_Statics::NewStructOps, TEXT("OWLEncodedPacket"), &Z_Registration_Info_UScriptStruct_OWLEncodedPacket, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOWLEncodedPacket), 2767592391U) },
		{ FOWLFFmpegSettings::StaticStruct, Z_Construct_UScriptStruct_FOWLFFmpegSettings_Statics::NewStructOps, TEXT("OWLFFmpegSettings"), &Z_Registration_Info_UScriptStruct_OWLFFmpegSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOWLFFmpegSettings), 1716476972U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLMedia_Public_OWLFFmpegOutput_h_3732223187(TEXT("/Script/OWLMedia"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLMedia_Public_OWLFFmpegOutput_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLMedia_Public_OWLFFmpegOutput_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLMedia_Public_OWLFFmpegOutput_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLMedia_Public_OWLFFmpegOutput_h_Statics::EnumInfo));
// End Registration
