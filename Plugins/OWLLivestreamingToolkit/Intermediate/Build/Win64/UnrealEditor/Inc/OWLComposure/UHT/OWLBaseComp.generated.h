...
public: \
	DECLARE_CLASS(AOWLBaseComp, ACompositingElement, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/OWLComposure"), NO_API) \
...
private: \
	...
	AOWLBaseComp(const AOWLBaseComp&); \
public: \
...
template<> OWLCOMPOSURE_API UClass* StaticClass<class AOWLBaseComp>();
