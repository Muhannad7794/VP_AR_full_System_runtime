...
#define FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLCamera_Public_OWLCaptureComponent_h_81_DELEGATE \
OWLCAMERA_API void FOnCaptureComponentResized_DelegateWrapper(const FMulticastScriptDelegate& OnCaptureComponentResized);


#define FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLCamera_Public_OWLCaptureComponent_h_465_DELEGATE \
static void FOnConvergenceDistanceChanged_DelegateWrapper(const FMulticastScriptDelegate& OnConvergenceDistanceChanged, float NewConvergenceDistance);


#define FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLCamera_Public_OWLCaptureComponent_h_87_RPC_WRAPPERS_NO_PURE_DECLS \
	DECLARE_FUNCTION(execOnConvergencePlaneManipulated); \
	DECLARE_FUNCTION(execSyncConvergenceWithFocus); \
	DECLARE_FUNCTION(execSetStereoConvergenceDistance); \
	DECLARE_FUNCTION(execGetConvergencePlane); \
	...
	DECLARE_FUNCTION(execAddShowOnlyActorComponents); \
...
#define FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLCamera_Public_OWLCaptureComponent_h_87_INCLASS_NO_PURE_DECLS \
private: \
...
#define FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLCamera_Public_OWLCaptureComponent_h_87_ENHANCED_CONSTRUCTORS \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	UOWLCaptureComponent(UOWLCaptureComponent&&); \
	UOWLCaptureComponent(const UOWLCaptureComponent&); \
public: \
...
#define FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLCamera_Public_OWLCaptureComponent_h_84_PROLOG
#define FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLCamera_Public_OWLCaptureComponent_h_87_GENERATED_BODY \
PRAGMA_DISABLE_DEPRECATION_WARNINGS \
public: \
	FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLCamera_Public_OWLCaptureComponent_h_87_RPC_WRAPPERS_NO_PURE_DECLS \
	FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLCamera_Public_OWLCaptureComponent_h_87_INCLASS_NO_PURE_DECLS \
	FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLCamera_Public_OWLCaptureComponent_h_87_ENHANCED_CONSTRUCTORS \
private: \
...
#define CURRENT_FILE_ID FID_CI_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLCamera_Public_OWLCaptureComponent_h
