...
private:
	...
	static bool UpdateDestRenderTargetIfNeeded(int Width, int Height, ETextureRenderTargetFormat Format,
...
private:;
	mutable TMap<FString, FTextureRHIRef> CachedTextures;
	mutable TMap<FString, FIntPoint> CachedDimensions;
	mutable TMap<FString, EPixelFormat> CachedFormats;
};
